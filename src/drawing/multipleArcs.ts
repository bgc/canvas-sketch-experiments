...
export const multipleArcs = (
  ...
  const availableSpace =
    DRAW_PROPERTIES.mid.x > DRAW_PROPERTIES.mid.y
      ? DRAW_PROPERTIES.mid.y - DRAW_PROPERTIES.margins
      : DRAW_PROPERTIES.mid.x - DRAW_PROPERTIES.margins
  const maxRadius =
    availableSpace < maximumRadius - DRAW_PROPERTIES.margins
      ? availableSpace
      : maximumRadius - DRAW_PROPERTIES.margins

  const maxAmmount = ammount > maximumRadius ? maximumRadius : ammount
